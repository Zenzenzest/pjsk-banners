import { cardFilterCategories, grouped } from "../Filter_constants";
              ...
              {options.map((option, i) => {
                ...
                const isSelected = (() => {
                  switch (category) {
                    ...
                    case "Unit":
                      return tempCardFilters.Unit.includes(option as string);
                    case "sub_unit":
                    ...
                    case "Type":
                      return tempCardFilters.Type.includes(option as string);
                    default:
                      return false;
                  }
                })();
                        ...
                        >
                          ...
                          <div
                            className={`px-2 py-1 rounded-full text-xs md:text-sm font-medium transition-colors ${
                              tempCardFilters["Type"].includes(option as string)
